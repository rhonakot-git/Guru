...
public class UserForm {
    ...
    @Length(max = 10, message = "パスワードは8文字以上10文字以内で入力してください")
    private String password;

    private String confirmPassword; // パスワード確認用

    @NotBlank(message = "ロールIDは必須です")
    @Length(max = 10, message = "ロールIDは10文字以内で入力してください")
    private String roleId;

    @NotBlank(message = "性別は必須です")
    @Length(max = 1, message = "性別は1文字で入力してください")
    ...
    @Length(max = 10, message = "郵便番号は10文字以内で入力してください")
